...
public class NhanVienV_ChinhSua extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    NhanVienV_ChinhSua frame = new NhanVienV_ChinhSua(1, 1);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
     ...
     */
    public NhanVienV_ChinhSua(int manv, int id) throws ClassNotFoundException {
    	this.id = id;
        ...
        btnQuayLai.addActionListener(e -> {NhanVienV_ChinhSua.this.dispose(); try {
			new NhanVienV(id);
		} catch (ClassNotFoundException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
